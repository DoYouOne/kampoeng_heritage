        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="portlet-body form">
                <form class="form-horizontal" role="form" action="{{ url('Sadmin_ulasan/aksi_tambah') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" style="width:100%;" id="anggota">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $k->tanggal }}</td>
                            <td>
                                <a href="{{ url('Sadmin_ulasan/update') }}/{{ $k->id_testi }}">
                                    <button type="button" class="btn btn-warning">Edit</button>
                                </a>
                                <a href="{{ url('Sadmin_ulasan/aksi_delete') }}/{{ $k->id_testi }}">
