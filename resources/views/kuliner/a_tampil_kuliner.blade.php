      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
                <a href="{{ url('Admin_kuliner/tambah') }}"><button class="btn btn-primary">Tambah Kuliner</button></a>
                <br><br><br>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" style="width:100%;" id="anggota">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $k->telepon }}</td>
                            <td>
                                <a href="{{ url('Admin_kuliner/update') }}/{{ $k->id }}">
                                    <button type="button" class="btn btn-warning">Edit</button>
                                </a>
                                <a href="{{ url('Admin_kuliner/aksi_delete') }}/{{ $k->id }}">
